...
{{-- ================= HERO ================= --}}
<section
  class="mt-4 bg-gradient-to-r from-green-700 to-green-600 text-white
         rounded-xl shadow-md overflow-hidden w-full max-w-full">

  <div
    class="px-4 py-10 sm:px-10
           flex flex-col sm:flex-row
           sm:items-center sm:justify-between
           gap-6 w-full max-w-full">
    ...
    <div class="max-w-full">
      ...
      <a href="#featured"
         class="mt-5 inline-block rounded-lg bg-white text-green-800
                px-5 py-2.5 text-sm font-semibold hover:bg-gray-100">
        Start Shopping
      </a>
    </div>

    {{-- RIGHT : PROMO MINI --}}
    <div class="grid grid-cols-2 gap-2 w-full sm:w-auto max-w-full">
...
<section class="mt-5 w-full max-w-full">
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-full">
...
{{-- ================= PRODUK ================= --}}
<section id="featured" class="py-6 w-full max-w-full">
  ...
  <div
    ...
    @forelse($produk as $item)
      <article
        class="group rounded-xl overflow-hidden border bg-white
