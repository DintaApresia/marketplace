...
<div class="max-w-3xl mx-auto mt-10 px-4">
    ...
    @if(
        ...
        <div class="mt-4 bg-white border rounded-xl p-5 sm:p-6">
            <p class="text-sm text-green-800">
                Akun kamu sudah terverifikasi sebagai
                <span class="font-semibold">penjual</span>.
                Kamu dapat mengakses <span class="font-semibold">Dashboard Penjual</span>
                dari menu penjual.
            </p>
        </div>
    ...
    @elseif($user->seller_status === 'pending')
        <div class="mt-4 bg-white border rounded-xl p-5 sm:p-6">
            <p class="text-sm text-yellow-800">
                Permintaan kamu untuk menjadi
                <span class="font-semibold">penjual</span>
                sedang dalam proses peninjauan oleh admin.
            </p>
            <p class="mt-2 text-xs text-gray-500">
                Kamu masih dapat berbelanja seperti biasa sebagai pembeli.
            </p>
        </div>

        @if(isset($penjual))
        <div class="mt-4 bg-white border rounded-xl p-5 sm:p-6 space-y-5">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Informasi ini bersifat read-only selama proses peninjauan.
                </p>
            </div>
            ...
            <div>
                ...
                <input
                    class="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-sm bg-gray-100"
        ...
        <div class="mt-4 bg-white border rounded-xl p-5 sm:p-6">
            ...
            @if($user->seller_status === 'rejected')
                <div class="mb-4 rounded-md bg-red-50 text-red-800 px-4 py-2 text-sm">
                    Permintaan sebelumnya <b>ditolak</b>.
            ...
            <form method="POST"
                ...
                <div>
                    ...
                    <textarea name="alamat_toko" rows="3" required
                        ...
                        class="mt-1 w-full rounded-md border border-gray-300 px-3 py-2 text-sm">{{ old('alamat_toko', $penjual->alamat_toko ?? '') }}</textarea>
                </div>
                ...
                <div class="flex justify-between items-center pt-4 border-t">
                    ...
                    <button type="submit"
                        class="bg-green-700 hover:bg-green-800 text-white px-4 py-2 rounded-md text-sm">
